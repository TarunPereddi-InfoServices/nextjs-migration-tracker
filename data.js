const migrationData = {
  ...
  technologyRoutes: [
    ...
    { id: "T002", route: "/technology/Gcp", status: "Done", notes: "GCP Technology page", assignedTo: "Manjusha", deliveryDate: "Completed" },
    { id: "T003", route: "/technology/Azure", status: "Done", notes: "Azure Technology page", assignedTo: "Manjusha", deliveryDate: "Completed" },
    { id: "T004", route: "/technology/Databricks", status: "Done", notes: "Databricks Technology page", assignedTo: "Manjusha", deliveryDate: "Completed" },
    { id: "T005", route: "/technology/Snowflake", status: "Done", notes: "Snowflake Technology page", assignedTo: "Manjusha", deliveryDate: "Completed" },
    { id: "T006", route: "/technology/Salesforce", status: "Done", notes: "Salesforce Technology page", assignedTo: "Manjusha", deliveryDate: "Completed" }
  ],
  ...
  productRoutes: [
    { id: "PRD001", route: "/product/observability-accelerator", status: "Pending", notes: "Observability Accelerator product page", assignedTo: "Leela", deliveryDate: "22/04/2025" }
  ],
  ...
  redirectsRoutes: [
    { id: "R001", route: "/services/cloud-native", status: "Done", notes: "Capability redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R002", route: "/services/xops", status: "Done", notes: "Capability redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R003", route: "/services/salesforce", status: "Done", notes: "Capability redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R004", route: "/services/technical-writing", status: "Done", notes: "Capability redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R005", route: "/services/cognitive-ai", status: "Done", notes: "Capability redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R006", route: "/services/generative-ai", status: "Done", notes: "Capability redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R007", route: "/services/quality-engineering", status: "Done", notes: "Capability redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R008", route: "/services/embedded-system", status: "Done", notes: "Capability redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R009", route: "/services/business-Intelligence", status: "Done", notes: "Capability redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R010", route: "/services/data-engineering", status: "Done", notes: "Capability redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R011", route: "/services/mobility-services", status: "Done", notes: "Capability redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R012", route: "/services/sap", status: "Done", notes: "Capability redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R013", route: "/cloud-technology/aws", status: "Done", notes: "Technology redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R014", route: "/cloud-technology/gcp", status: "Done", notes: "Technology redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R015", route: "/cloud-technology/azure", status: "Done", notes: "Technology redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R016", route: "/cloud-technology/databricks", status: "Done", notes: "Technology redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R017", route: "/cloud-technology/snowflake", status: "Done", notes: "Technology redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R018", route: "/cloud-technology/salesforce", status: "Done", notes: "Technology redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R019", route: "/contact-us", status: "Done", notes: "Core page redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R020", route: "/case-study/iguroo", status: "Done", notes: "Case study redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R021", route: "/case-study/gentoo", status: "Done", notes: "Case study redirect", assignedTo: "Tarun", deliveryDate: "22/04/2025" },
    { id: "R022", route: "/:path*.html", status: "Done", notes: "HTML extension handler", assignedTo: "Tarun", deliveryDate: "22/04/2025" }
  ],
